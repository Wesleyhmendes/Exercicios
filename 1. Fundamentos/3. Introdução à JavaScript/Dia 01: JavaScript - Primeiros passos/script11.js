...
if(salarioBruto <= faixa1Inss){
  inss=salarioBruto0.08;
}
else if(salarioBruto <= faixa2Inss){
  inss=salarioBruto0.09;
}
else if(salarioBruto <= faixa3Inss){
  inss=salarioBruto0.11;
}
else{
  inss=570.88;
}
...
if(baseSalario <= faixa1Ir){
  ...
  salarioLiquido =baseSalario - (baseSalario0.075) - 142.80;
}
else if(baseSalario <= faixa3Ir ){
  salarioLiquido =baseSalario - (baseSalario0.15) - 354.80;
}
else if(baseSalario <= faixa4Ir ){
  salarioLiquido =baseSalario - (baseSalario0.225) - 636.13;
}
